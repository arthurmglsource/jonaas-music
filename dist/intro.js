...
const assets=[document.querySelector('.hero-photo'),document.querySelector('.hero-signature')];
const ready=assets.map(img=>Promise.resolve().then(()=>img.decode?.()).catch(()=>{}));
